...
const Home = () => {
  ...
  return (
    <div className='bg-gradient-to-b from-black to-gray-800 pb-8'>
      <motion.div
        ...
        <div className='flex flex-col justify-center h-full lg:ml-14 xl:ml-0 mt-36'>
          ...
          <motion.h3
            ...
            className='text-white lg:text-center my-6 tracking-[.25em] text-center'>
            {Array.from('Hello World!').map((letter, index) => (
